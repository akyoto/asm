...
func TestMoveRegisterNumber(t *testing.T) {
	usagePatterns := []struct {
		...
		// Memory references
		{"[rax] 8b", 0x7f, []byte{0x48, 0xc7, 0x00, 0x7f, 0x00, 0x00, 0x00}},
		{"[rax] 4b", 0x7f, []byte{0xc7, 0x00, 0x7f, 0x00, 0x00, 0x00}},
		{"[rax] 2b", 0x7f, []byte{0x66, 0xc7, 0x00, 0x7f, 0x00}},
		{"[rax] 1b", 0x7f, []byte{0xc6, 0x00, 0x7f}},
		{"[rcx] 8b", 0x7f, []byte{0x48, 0xc7, 0x01, 0x7f, 0x00, 0x00, 0x00}},
		{"[rcx] 4b", 0x7f, []byte{0xc7, 0x01, 0x7f, 0x00, 0x00, 0x00}},
		{"[rcx] 2b", 0x7f, []byte{0x66, 0xc7, 0x01, 0x7f, 0x00}},
		{"[rcx] 1b", 0x7f, []byte{0xc6, 0x01, 0x7f}},
		{"[eax] 4b", 0x7f, []byte{0x67, 0xc7, 0x00, 0x7f, 0x00, 0x00, 0x00}},
		{"[ecx] 4b", 0x7f, []byte{0x67, 0xc7, 0x01, 0x7f, 0x00, 0x00, 0x00}},
		{"[rdx] 8b", 0x7f, []byte{0x48, 0xc7, 0x02, 0x7f, 0x00, 0x00, 0x00}},
		{"[edx] 4b", 0x7f, []byte{0x67, 0xc7, 0x02, 0x7f, 0x00, 0x00, 0x00}},
		{"[rbx] 8b", 0x7f, []byte{0x48, 0xc7, 0x03, 0x7f, 0x00, 0x00, 0x00}},
		{"[ebx] 4b", 0x7f, []byte{0x67, 0xc7, 0x03, 0x7f, 0x00, 0x00, 0x00}},
		{"[rsi] 8b", 0x7f, []byte{0x48, 0xc7, 0x06, 0x7f, 0x00, 0x00, 0x00}},
		{"[esi] 4b", 0x7f, []byte{0x67, 0xc7, 0x06, 0x7f, 0x00, 0x00, 0x00}},
		{"[rdi] 8b", 0x7f, []byte{0x48, 0xc7, 0x07, 0x7f, 0x00, 0x00, 0x00}},
		{"[edi] 4b", 0x7f, []byte{0x67, 0xc7, 0x07, 0x7f, 0x00, 0x00, 0x00}},
		{"[rsp] 8b", 0x7f, []byte{0x48, 0xc7, 0x04, 0x24, 0x7f, 0x00, 0x00, 0x00}},
		{"[esp] 4b", 0x7f, []byte{0x67, 0xc7, 0x04, 0x24, 0x7f, 0x00, 0x00, 0x00}},
		{"[rbp] 8b", 0x7f, []byte{0x48, 0xc7, 0x45, 0x00, 0x7f, 0x00, 0x00, 0x00}},
		{"[ebp] 4b", 0x7f, []byte{0x67, 0xc7, 0x45, 0x00, 0x7f, 0x00, 0x00, 0x00}},
		{"[r8] 8b", 0x7f, []byte{0x49, 0xc7, 0x00, 0x7f, 0x00, 0x00, 0x00, 0x00}},
		{"[r8d] 4b", 0x7f, []byte{0x67, 0x41, 0xc7, 0x00, 0x7f, 0x00, 0x00, 0x00}},
		{"[r9] 8b", 0x7f, []byte{0x49, 0xc7, 0x01, 0x7f, 0x00, 0x00, 0x00}},
		{"[r9d] 4b", 0x7f, []byte{0x67, 0x41, 0xc7, 0x01, 0x7f, 0x00, 0x00, 0x00}},
		{"[r10] 8b", 0x7f, []byte{0x49, 0xc7, 0x02, 0x7f, 0x00, 0x00, 0x00}},
		{"[r10d] 4b", 0x7f, []byte{0x67, 0x41, 0xc7, 0x02, 0x7f, 0x00, 0x00, 0x00}},
		{"[r11] 8b", 0x7f, []byte{0x49, 0xc7, 0x03, 0x7f, 0x00, 0x00, 0x00}},
		{"[r11d] 4b", 0x7f, []byte{0x67, 0x41, 0xc7, 0x03, 0x7f, 0x00, 0x00, 0x00}},
		{"[r12] 8b", 0x7f, []byte{0x49, 0xc7, 0x04, 0x24, 0x7f, 0x00, 0x00, 0x00}},
		{"[r12d] 4b", 0x7f, []byte{0x67, 0x41, 0xc7, 0x04, 0x24, 0x7f, 0x00, 0x00, 0x00}},
		{"[r13] 8b", 0x7f, []byte{0x49, 0xc7, 0x45, 0x00, 0x7f, 0x00, 0x00, 0x00}},
		{"[r13d] 4b", 0x7f, []byte{0x67, 0x41, 0xc7, 0x45, 0x00, 0x7f, 0x00, 0x00, 0x00}},
		{"[r14] 8b", 0x7f, []byte{0x49, 0xc7, 0x06, 0x7f, 0x00, 0x00, 0x00}},
		{"[r14d] 4b", 0x7f, []byte{0x67, 0x41, 0xc7, 0x06, 0x7f, 0x00, 0x00, 0x00}},
		{"[r15] 8b", 0x7f, []byte{0x49, 0xc7, 0x07, 0x7f, 0x00, 0x00, 0x00}},
		{"[r15d] 4b", 0x7f, []byte{0x67, 0x41, 0xc7, 0x07, 0x7f, 0x00, 0x00, 0x00}},
	}
